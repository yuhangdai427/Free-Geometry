...
| DA3 | 7scenes | 7 | +3.81% | −0.74% | +2.45% | −1.65% | +0.4% | 1/6 |
| DA3 | scannetpp | 20 | −0.55%* | −0.66%* | −0.30%* | −0.13%* | +0.6% | 11/9 |
| DA3 | hiroom | 30 | +4.08% | +1.55% | +1.78% | +0.45% | +16.8%⚠ | 9/21 |
| DA3 | dtu | 22 | +0.45% | n/a | +0.17% | n/a | **+63.4%→+16.1%** | 8/14 |
| DA3 | dtu64 | 13 | +0.94% | n/a | +0.86% | n/a | n/a | 2/11 |
| VGGT | eth3d | 12 | +18.58% | +0.24% | +16.74% | +0.42% | +2.7% | 1/10 |
| VGGT | 7scenes | 7 | −9.45% | +6.30% | −9.45% | +6.30% | +0.9% | 0/7 |
| VGGT | scannetpp | 21 | +3.21% | −1.42% | +3.56% | −0.60% | +0.4% | 2/18 |
| VGGT | hiroom | 31 | **+7.66%** | **+12.01%** | +0.38% | +14.32% | +8.3% | 5/25 |
...
| 臂 | dAUC uplift | dF1 uplift | 判定 |
|---|---|---|---|
| masked 位置加权 w×=(1+corr) | −0.29pp | **+1.61pp** | 稳定小正（4/5 场景 F1 改善）；机制：轨迹更健康→selector 能挑中间步 |
| quantile-couple（分位匹配替换标量 couple） | **+2.27pp** | **+1.88pp** | 高方差：relief +9.4/+13.9pp 大救、courtyard −7.2pp 被伤；需门控 |

两者互补，均为候选增量（n=5，统计弱，需全量验证后再进主线）。
