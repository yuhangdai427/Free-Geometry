...
V2="--v2_ab --v2_probe --v2_ckpt --v2_rel_weight 1.0 --v2_grad_cap --v2_qfeat_off --v2_rel_gate_deg 0 --loss_all_pos --v2_baselines_json workspace/protocol_v2/baselines.json"
