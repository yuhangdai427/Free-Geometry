#!/usr/bin/env python3
"""Counterfactual gauge-repair fusion for scannetpp (eval-side recoupling).

Variants per scene-arm @100v (npz under gauge_scan/eval32/<arm>@100v):
...
Run from repo root:
  ...
  CUDA_VISIBLE_DEVICES="" python3 diagnostics/free_geometry/gauge_scannetpp_fuse.py \
      --scenes 1ada7a0617 ... --variants fixgt fixfree
"""
