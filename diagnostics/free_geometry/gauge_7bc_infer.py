#!/usr/bin/env python3
"""Gauge npz regeneration for the 7bc286c1b6 random_forced controlled run:
arms A0_baseline + C2M_maskrel @100v (with conf, needed by the GT-free factor
search), from scannetpp_7bc_random ckpts. Output to <run_root>/gauge_7bc/eval32
(eval32/ untouched). GPU inference; waits for >=15 GB free. New file; does not
